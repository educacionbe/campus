...
class MoodletxtOutboundSMSStatus {
    ...
    /**
     * Status indicating message is initially blacklisted. 
     * The message is still queued for delivery in case the user's status 
     * changes prior to sending. This usually applies to scheduled messages.
     * @var int
     */
    public static $STATUS_BLACK_LISTED_INITIAL = -5;
    
    /**
     * Status indicating message is blacklisted. 
     * The message is dead - you can't send to this number, it won't be 
     * delivered, don't re-send. 
     * @var int
     */
    public static $STATUS_BLACK_LISTED = -4;
    
    /**
     * Status indicating message is pending a welcome status. 
     * Messages pending a welcome status have not been sent and won't be re-sent 
     * by ConnectTxt, as the user has not received a welcome message.
     * @var int
     */
    public static $STATUS_PENDING_WELCOME_STATUS = -3;
    
    /**
     * Status indicating message is queued, and a welcome message is also 
     * automatically generated and queued. This generally happens when new 
     * numbers enter the system.
     * @var int
     */
    public static $STATUS_QUEUED_MESSAGE_AND_WELCOME_MESSAGE_STATUS = -2;
